...
describe '180 DSDataEdited', ->
  ...
  it 'general', ->
    ...
    serverData = new ServerData owner, 'serverData', {}; serverData.set 'status', 'ready'
    changes = new Changes owner, 'changes'; changes.set 'status', 'ready'
